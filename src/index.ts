...
export { renderDiorama, renderEditorial, renderRisograph, renderInkwash, renderAnimated, animePrompt, RENDER_STYLES } from "./render/index.ts";
export type { RenderOptions, RenderStyle, AnimePrompt } from "./render/index.ts";
export {
  CANON, theSwitch, footbridge, loop, fatVillain, yard, consenting, transplant, tunnel, triage, alignment,
} from "./canon.ts";
export { probe, reframings, anthropicModel, mockModel, renderProbeStrip, renderProbeCompare, probeReport } from "./probe.ts";
export type { AskModel, Reframing, ProbeResult, MockProfile } from "./probe.ts";
